...
import { IoMail, IoCall, IoLocationOutline, IoLogoGithub, IoLogoLinkedin } from "react-icons/io5";
        ...
        >
          ...
          <div className="space-y-6">
            ...
            <form className="space-y-6" onSubmit={(e) => {
              ...
              <div>
                <label htmlFor="name" className="block text-sm font-medium text-light-black-33 mb-2">
                  Name
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="email" className="block text-sm font-medium text-light-black-33 mb-2">
                  Email
                </label>
                <input
                  type="email"
              ...
              <div>
                <label htmlFor="subject" className="block text-sm font-medium text-light-black-33 mb-2">
                  Subject
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="message" className="block text-sm font-medium text-light-black-33 mb-2">
                  Message
                </label>
                <textarea
                  id="message"
