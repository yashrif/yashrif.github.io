...
import { IoLogoGithub, IoOpenOutline, IoCalendarOutline } from "react-icons/io5";

import { categories, description, projects, title } from "../assets/data/projects";
import {
  springSingleBounce,
  viewportAmount,
  viewportMargin,
    ...
    >
      ...
      <div className="p-6">
        <div className="flex items-center justify-between mb-2">
          <span className="text-sm text-light-violet-d7 font-medium">{category}</span>
  ...
  const filteredProjects = activeCategory === "All"
    ...
    : projects.filter(project => {
        switch(activeCategory) {
          case "AI-Powered":
            return project.title === "Roamance" || project.title === "StudySync";
          case "Web Applications":
            return ["EcoSync", "Flourish", "DocLab", "IIT-JU Website"].includes(project.title);
          case "Mobile Apps":
